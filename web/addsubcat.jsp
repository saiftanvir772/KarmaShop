                    ...
                    <div class="col-lg-8">
                        <form action="subcatagory.htm">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control"  placeholder="Enter Sub Category Name" name="subCatName">
                                <small  class="form-text text-muted">Please do not create existing category.</small>
                            </div>
                            <div class="form-group">
                                <label>Short Description :</label>
                                <input type="text" class="form-control" placeholder="Description" name="subCatDesc">
                            </div>
