            ...
            <div class="container">
                <div class="row fullscreen align-items-center justify-content-start">
                        ...
                        <form action="selCat.htm">
                            <div class="row">
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <select class="form-control" name="catName" style="padding-right: 50px">
                                        <c:forEach items="${clist}" var="a">
                                            <option class="dropdown-item text-dark" value="${a.catName}"> ${a.catName}</option>
                                        </c:forEach>
                                    </select>
                    ...
                    <div class="col-lg-8" style="padding-top: 100px">
                        <form action="productAdd.htm" method="POST">
                            <div class="form-group">
                                    <label>Category Name :</label>
                                    <input type="text" class="form-control" placeholder="Description" name="catName" value="${pro.catName}" readonly>
                                </div>
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-4">
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <select class="form-control" name="subCatName">
                                            <c:forEach items="${list}" var="b">
                                                <option class="dropdown-item text-dark" value="${b.subCatName}"> ${b.subCatName}</option>
                                            </c:forEach>
                                        </select>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Description" name="proName">
                            </div>
                            <div class="form-group">
                                <label>Product Quantity :</label>
                                <input type="number" class="form-control" placeholder="Description" name="proQty">
                            </div>
                            <div class="form-group">
                                <label>Price :</label>
                                <input type="number" class="form-control" placeholder="Description" name="proPrice">
                            </div>
                            <div class="form-group">
                                <label>Image :</label>
                                <input type="file" class="form-control" placeholder="Description" name="proImg">
                            </div>
                            <div class="form-group">
                                <label>Brand :</label>
                                <input type="text" class="form-control" placeholder="Description" name="proBrand">
                            </div>
