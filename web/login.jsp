...
<html>
                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                <li class="nav-item"><a href="bag.htm" class="cart"><span class="ti-bag"><c:out value="${numberOfProduct}"></c:out></span></a></li>
                                <li class="nav-item">
        ...
        <div>
            ...
            <div class="container">
                <div class="row fullscreen align-items-center justify-content-start">
                    <div class="col-md-4">
                        <h3>Make Better Shopping</h3>
                        <img src="resources/img/features/shopping-bag.png" alt="" style="height: 80%; width: 80%"/>
                    </div>
                    <div class="col-md-8">
                        <h1>Welcome to Karma! Please login.</h1>
                      <form>
  ...
  <div class="form-group">
    ...
    <label class="form-check-label"  style="float: right"><a href="#">New User?</a>/<a href="#">Forget Password?</a></label>
  </div>
