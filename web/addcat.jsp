...
<html lang="zxx" class="no-js">
    ...
    <body>
                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                            <ul class="nav navbar-nav menu_nav ml-auto">
                                ...
                                <li class="nav-item active"><a class="nav-link" href="addcat.htm">Add Category</a></li>
        ...
        <section class="banner-area">
            <div class="container">
                <h1>Product Categories Add Option</h1>
                <div class="row fullscreen align-items-center justify-content-start">
                    <div class="col-lg-4">
                        <h2>Add Product Category</h2>
                    </div>
                    <div class="col-lg-8" style="align-content: center">
                        <h1>Please Fill Up All The Fields.</h1>
                        <form action="catagory.htm">
                            <div class="form-group">
                                <label>Category Name</label>
                                <input type="text" class="form-control"  placeholder="Enter Category Name" name="catName">
                                <small  class="form-text text-muted">Please do not create existing category.</small>
                            </div>
                            <div class="form-group">
                                <label>Short Description :</label>
                                <input type="text" class="form-control" placeholder="Description" name="catDesc">
                            </div>
