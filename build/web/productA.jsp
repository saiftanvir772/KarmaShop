                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                            <ul class="nav navbar-nav menu_nav ml-auto">
                                <li class="nav-item"><a class="nav-link" href="allOrder.htm">Order</a></li>
                                <li class="nav-item active"><a class="nav-link" href="productA.htm">Product</a></li>
                ...
                <div class="container">
                    <div class="row fullscreen align-items-center justify-content-start">
                        <div class="row" style="text-align: center; font-weight: bold; padding-bottom: 25px; padding-left: 50px"  ng-controller="myCtrl" | filter: 'search'>
                             <form action="proReport.jsp">
                             <table border="1" cellspacing="10" cellpadding="10" class="table table-responsive-md table-striped">
                                 <tr>
                                     <td>Product ID</td>
                                     <td>Product Name</td>
                             ...
                             <c:forEach items="${list}" var="a">
                                 <tr>
                                     ...
                                     <td>${a.proPrice}</td>
                                     <td>${a.proBrand}</td>
                                     <td> <a href="edit.htm?proId=${a.proId}&&proName=${a.proName}&&catName=${a.catName}&&subCatName=${a.subCatName}&&proQty=${a.proQty}&&proPrice=${a.proPrice}&&proBrand=${a.proBrand}"> Edit </a> </td>
                                     <td> <a href="del.htm?proId=${a.proId}"> Delete </a> </td>
                                 </tr>
                            </c:forEach>
                                 <tr>
                                     <td colspan="10"><input type="submit" style="text-decoration: none" value="View in PDF"></input></td>
                                 </tr>
                        </table>
                            </form>
