        ...
        <div>
            ...
            <div class="container">
                <div class="row fullscreen align-items-center justify-content-start">
                    ...
                    <div class="col-md-8">
                        <h1>Welcome Admin to Karma! Please login.</h1>
                        <form action="adminlog.htm">
                            ...
                            <div class="form-check">
                                ...
                                <label class="form-check-label"  style="float: right"><a href="#" data-toggle="modal" data-target="#exampleModal">Sign up?</a>/<a href="#">Forget Password?</a></label>
                            </div>
