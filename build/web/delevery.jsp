        ...
        <section class="banner-area">
            <div class="container">
                <div class="row fullscreen align-items-center justify-content-start">
                    ...
                    <div class="col-md-6">
                        <h2>Please fill up the following form!</h2>
                        <form class="form-check-input" action="delivary.htm">
                            <fieldset style="border: 2px #1e7e34 ">
                                <legend>Delivery Address <b style="color: green">We Offer Free Delivery in Dhaka.</b></legend>
                                <table cellpadding="10">
                                     ...
                                     <tr>
                                        ...
                                        <td>
                                            <select name="zoneName">
                                                ...
                                                <option value="mirpur">Azimpur</option>
                                            </select>
                                    ...
                                    <tr>
                                        <td>
                                            <input type="hidden" name="paytk" value="${totalPrice}"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <input type="hidden" name="prodetail" value="${pro}"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
