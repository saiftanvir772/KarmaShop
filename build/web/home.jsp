                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                <li class="nav-item"><a href="bag.htm" class="cart">
                                        <span class="ti-bag">
                            ...
                            <div class="row single-slide align-items-center d-flex">
                                <div class="col-lg-5 col-md-6">
                                    <div class="banner-content">
                                        <h1>Xoiomi New <br>Collection!</h1>
                                        <p>Xiaomi MiA1 Smartphone 5.5" - 4GB RAM - 64GB ROM - 12MP Camera.</p>
                                ...
                                <div class="col-lg-7">
                                    <div class="banner-img">
                                        ...
                                        <img src="resources/img/product/Asus vivobook.PNG" alt=""/>
                    ...
                    <div class="col-lg-8 col-md-12">
                        <div class="row">
                            <div class="col-lg-8 col-md-8">
                                <div class="single-deal" style="height: 60%; width: 60%">
                                    <div class="overlay"></div>
                                    <img class="img-fluid w-100" src="resources/img/product/alpha a7 mirrorless digital camera.PNG" alt="">
                                    <a href="resources/img/product/alpha a7 mirrorless digital camera.PNG" class="img-pop-up" target="_blank">
                                        <div class="deal-details">
                                            <h6 class="deal-title">Save Your special moment</h6>
                                        </div>
                                    </a>
